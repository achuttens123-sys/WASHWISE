    ...
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      >
        ...
        <div className="text-center space-y-4">
          <motion.div 
            ...
            className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto shadow-sm ${
              isRejected ? 'bg-red-100' : isRescheduled ? 'bg-blue-100' : 'bg-green-100'
            }`}
          >
            {isRejected ? (
        ...
        <div className="flex flex-col sm:flex-row gap-4 no-print">
          <button 
            onClick={handlePrint}
            className="flex-1 py-4 bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300 font-bold rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-all flex items-center justify-center shadow-sm"
          >
            <Printer className="w-5 h-5 mr-2" /> Print Challan
          </button>
          <button 
            onClick={() => navigate('/dashboard')}
            className="flex-1 py-4 bg-blue-600 text-white font-bold rounded-2xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 dark:shadow-none flex items-center justify-center"
          >
